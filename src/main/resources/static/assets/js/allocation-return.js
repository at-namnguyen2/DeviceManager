		...
		$.ajax({
			...
			success : function(value) {
				...
				$.each(value,function(key, all) {
					...
					+ "<td><h6>"+ all.employeeName + "</h6>" 
					+ "<small class=\"text-muted\">"+ all.email + "</small></td>"
					+ "<td>"+ all.team + "</td>"
					+ "<td>"+ all.deviceName + "</td>" 
					+ "<td>"+ all.productId + "</td>" 
					+"<td>" + all.dateDeliverReceive +"</td>"
	...
	function listHistory(p) {
		$.ajax({
			...
			success : function(value) {
				...
				+ "<td>"+ all.team + "</td><td>"+ all.deviceName + "</td>" 
				+ "<td>"+ all.productId + "</td>" 
				+ "<td>"+ all.dateReturn + "</td>"
