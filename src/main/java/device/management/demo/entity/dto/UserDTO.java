...
public class UserDTO implements Serializable{
	...
	public String toString() {
		return "UserDTO [id=" + id + ", email=" + email + ", fullname=" + fullname + ", phone=" + phone + ", birthDay="
				+ birthDay + ", address=" + address + ", gender=" + gender + ", team=" + team + ", password=" + password
				+ ", matchingPassword=" + matchingPassword + ", description=" + description + ", employeeName="
				+ employeeName + "]";
	}
}
